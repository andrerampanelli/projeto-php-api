...
INSERT INTO `users` (`id`, `name`, `description`, `email`, `password`, `created`, `modified`) VALUES
(1, 'Admin', 'Administrador do sistema.', 'admin@admin.com', sha1('admin'), '2014-06-01 00:35:07', '2014-05-30 17:34:33');
